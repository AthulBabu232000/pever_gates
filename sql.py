def _enable_logging(f):
    ...
    def decorator(*args, **kwargs):
        ...
        # Enable logging
        disabled = logging.getLogger("sqlAlchemy").disabled
        if flask.current_app:
            logging.getLogger("sqlAlchemy").disabled = False
        try:
            return f(*args, **kwargs)
        finally:
            logging.getLogger("sqlAlchemy").disabled = disabled
...
class SQL(object):
    ...
    def __init__(self, url, **kwargs):
        ...
        # Get logger
        self._logger = logging.getLogger("sqlAlchemy")
